...
import com.sr_developers.sowetodrycleaners.adapters.AdapterBed;
...
public class DryCleaningActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Bedding's Cleaning Services");

        upgrade = findViewById(R.id.fab_add);
        progressDialog = new ProgressDialog(DryCleaningActivity.this);
        progressDialog.setMessage("Please wait....");
        progressDialog.setCanceledOnTouchOutside(false);
        dialog = new Dialog(DryCleaningActivity.this);


        linearLayoutManager = new LinearLayoutManager(DryCleaningActivity.this);
        dialog = new Dialog(DryCleaningActivity.this);
        ...
        upgrade.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                back.setText(" Bedding's Cleaning Services");
                LinearLayout one= dialog.findViewById(R.id.bedding);
                ...
                date.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        DatePickerDialog datePickerDialog = new DatePickerDialog(
                                DryCleaningActivity.this, new DatePickerDialog.OnDateSetListener() {
                            @Override
                ...
                submit.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (Name.isEmpty()) {
                            Toast.makeText(DryCleaningActivity.this, "Enter Item Name", Toast.LENGTH_SHORT).show();
                            return;
                        }
                        if (Kgs.isEmpty()) {
                            Toast.makeText(DryCleaningActivity.this, "Please Specify Weight/Quantity/Size", Toast.LENGTH_SHORT).show();
                            return;
                        }
                        if (Price.isEmpty()) {
                            Toast.makeText(DryCleaningActivity.this, "Enter Total Price", Toast.LENGTH_SHORT).show();
                            return;
                        }
                        if (Date.isEmpty()) {
                            Toast.makeText(DryCleaningActivity.this, "Enter Date", Toast.LENGTH_SHORT).show();
                            return;
                        }
...
//                                    startActivity(intent);
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == RaveConstants.RAVE_REQUEST_CODE && data != null) {
            ...
            if (resultCode == RavePayActivity.RESULT_SUCCESS) {
                ...
                Toast.makeText(DryCleaningActivity.this, "ERROR " + message, Toast.LENGTH_LONG).show();
            } else if (resultCode == RavePayActivity.RESULT_CANCELLED) {
                Toast.makeText(DryCleaningActivity.this, "CANCELLED ", Toast.LENGTH_LONG).show();
            }
    ...
    private void getData() {
        ...
        reference.child(noders.BEDDING).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()) {
                    ...
                    adapterBed = new AdapterBed(DryCleaningActivity.this, orderDetailsArrayList);
                    recyclerView.setAdapter(adapterBed);
                } else {
                    progress_circular.setVisibility(View.GONE);
                    tvData.setVisibility(View.VISIBLE);
                    recyclerView.setVisibility(View.GONE);
    ...
    private void saveData(String name, String kgs, String price, String date) {
        ...
        data.put("id", firebaseAuth.getUid());
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference(noders.SERVICE_NODE);
        reference.child(noders.BEDDING).child(time).setValue(data).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isComplete()) {
                    Toast.makeText(DryCleaningActivity.this, "Saved Successfully", Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(DryCleaningActivity.this, "Failed" + e.getMessage(), Toast.LENGTH_SHORT).show();
                progressDialog.dismiss();
